...
class TaskDetailActivity : AppCompatActivity() {
    private var task: Task? = null //task, tarefa ainda vai sair do escopo, ser inicializada
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.delete_task -> {
//so vai deletar se a tarefa existir , senao finish
                if (task != null) {
